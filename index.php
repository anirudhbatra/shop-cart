...
-->
	<div class="well well-small">
	  ...
	  <hr class="soften"/>
		...
		<div class="row-fluid">
		  <ul class="thumbnails">
			<li class="span4">
			  <div class="thumbnail"> <a href="index.php"><img src="assets/img/b.jpg" alt=""></a>
			...
			<li class="span4">
			  <div class="thumbnail"> <a href="index.php"><img src="assets/img/c.jpg" alt=""></a>
				<div class="caption cntr">
				  <p>LIME</p>
			...
			<li class="span4">
			  <div class="thumbnail"> <a href="index.php"><img src="assets/img/a.jpg" alt=""></a>
				<div class="caption cntr">
				  <p>KIWI</p>
	...
	-->
		<div class="well well-small">
		  <h3><a class="btn btn-mini pull-right" href="products.php" title="View more">VIew More<span class="icon-plus"></span></a>Products </h3>
		  <hr class="soften"/>
		  <div class="row-fluid">
		  <ul class="thumbnails">
			<li class="span4">
			  <div class="thumbnail"> <a  href="index.php"><img src="assets/img/d.jpg" alt=""></a>
				<div class="caption">
				  <h5>MANGOES</h5>
				  <h4>RS 100/kg</h4>
				</div>
			...
			<li class="span4">
			  <div class="thumbnail"> <a  href="index.php"><img src="assets/img/e.jpg" alt=""></a>
				<div class="caption">
				  <h5>WATERMELON</h5>
				  <h4>  RS 50/kg</h4>
				</div>
			...
			<li class="span4">
			  <div class="thumbnail"> <a  href="index.php"><img src="assets/img/f.jpg" alt=""/></a>
				<div class="caption">
				  <h5>ORANGES</h5>
				  <h4>RS 70/kg</h4>
				</div>
